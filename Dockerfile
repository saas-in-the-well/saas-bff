...
COPY build/libs/saas-bff-application-0.0.1-SNAPSHOT.jar /app/saas-bff-application-0.0.1-SNAPSHOT.jar

# 어플리케이션을 실행합니다.
CMD ["java", "-Dspring.profiles.active=dev", "-jar", "saas-bff-application-0.0.1-SNAPSHOT.jar"]